...
<nav class={`bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0  `}  >
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
     <Link to={'/login'}>
      <button type="button" class="text-white bg-[#92D300] hover:bg-green-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign-IN</button>
      </Link> 
    
      {isMenuOpen ?
               <svg onClick={toggleMenu} className="w-10 h-10 sm:hidden block "  fill="black" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
               </svg>
               :
               <svg onClick={toggleMenu} className="w-10 h-10 bg-white text-black" aria-hidden="true" fill="black" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
               </svg>
            }
  ...
  {isMenuOpen &&
  <div class="items-center animated  justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
