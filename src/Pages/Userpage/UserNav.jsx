...
<nav class={`bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0  `}  >
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
     <Link to={'/login'}>
      <button type="button" class="text-white bg-[#92D300] hover:bg-green-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Logout</button>
      </Link> 
